...
{
    return invoke_syscall(SYSCALL_THREAD_CREATE, (long)start_routine, mem_top, ra, (long)arg, IGNORE);
}
...
{
    /* TODO: [p5-task4] call invoke_syscall to implement sys_net_recv_stream */
