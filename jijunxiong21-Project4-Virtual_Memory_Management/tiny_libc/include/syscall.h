...
#define SYSCALL_FORK 8 // personnaly defined
#define SYSCALL_THREAD_CREATE 10 // personnaly defined
#define SYSCALL_THREAD_YIELD 11 // personnaly defined
#define SYSCALL_THREAD_JOIN 12 // personnaly defined
#define SYSCALL_THREAD_EXIT 13 // personnaly defined
#define SYSCALL_MOVEUP 14 // personnaly defined
#define SYSCALL_GET_CPUID 15 // personnaly defined
#define SYSCALL_TASKSET 16 // personnaly defined
